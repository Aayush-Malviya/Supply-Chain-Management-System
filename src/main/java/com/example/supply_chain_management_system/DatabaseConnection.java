...
public class DatabaseConnection {
    private static final String databaseUrl = "jdbc:mysql://localhost:3306/supply_chain_db";
    private static final String userName = "root";
    private static final String password = "sql@12"; //your actual sql password
    ...
    public int executeUpdateQuery(String query){ //will help in execute insert & update db
        Statement statement = getStatement();
        try {
